! function(i) {
    ...
    o = 0, (r = function(i, e) {
        ...
        for (var i = this, e = 0, t = 0, o = [], s = !1 === i.options.infinite ? i.slideCount : (e = i.options.slidesToScroll * -Math.ceil(i.slideCount / 2), t = i.options.slidesToScroll * -Math.ceil(i.slideCount / 2), 2 * i.slideCount); e < s;) o.push(e), e = t + i.options.slidesToScroll, t += i.options.slidesToScroll <= i.options.slidesToShow ? i.options.slidesToScroll : i.options.slidesToShow;
        return o
